...
const sResult seqOrgaResult = { END_OF_SEQUENCE_RESTART_ID /* Dir sortie */, 100  /* Son */, false };
...
const sResult seqInitiationResult = { END_OF_SEQUENCE_CONTINUE_DIR_ID /* Dir sortie */, 1  /* Son */, false };
...
const sResult seqRenforcementResultDir1 = { 2 /* Dir sortie */, 2  /* Son */, false };
...
const sResult seqRenforcementResultDir2 = { 3 /* Dir sortie */, 2  /* Son */, false };
...
const sResult seqRenforcementResultDir3 = { END_OF_SEQUENCE_CONTINUE_DIR_ID /* Dir sortie */, 2  /* Son */, false };
